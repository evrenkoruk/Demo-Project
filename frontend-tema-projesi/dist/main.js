...
function n(o){
    ...
    n.t=function(e,t){
        ...
        if(n.r(o),Object.defineProperty(o,"default",{enumerable:!0,value:e}),2&t&&"string"!=typeof e)for(var r in e)n.d(o,r,function(t){return e[t]}.bind(null,r));return o
    },
    n.n=function(e){
...
var r=document.querySelector(".nav-toggle"), i=document.querySelector(".menu-toggle");
...
document.querySelector(".dropdown a").addEventListener("click",(function(e){
    ...
    document.querySelector(".second-level a").addEventListener("click",(function(e){
        this.nextElementSibling.classList.toggle("show"),
        this.parentNode.classList.toggle("active"),e.stopPropagation()
    }))},function(e,t,n){}]);